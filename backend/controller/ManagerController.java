...
public class ManagerController {
	...
	//manager login
		@GetMapping("manager/login") //username/password
		public ManagerDto login(Principal principal) {
			String username = principal.getName();
			Manager mgr = managerRepository.getByUsername(username);
			ManagerDto dto = new ManagerDto();
			//dto.setId(mgr.getId());
			dto.setName(mgr.getName());
			//dto.setUsername(mgr.getUsername());
			//dto.setPointsGiven(mgr.getPointsGiven());
			return dto; 
		}
}
